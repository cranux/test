...
//        $members = $this->repository->skipCriteria()->paginate();
//        $this->repository->setPresenter(new MemberPresenter());
//        $members = $this->repository->skipPresenter()->paginate();
        $members = $this->repository->paginate();

        return response_json(1001,'获取成功', $members);
